...
const NewInvoiceForm = () => {
  ...
  return (
    <>
      ...
      <div onClick={() => setOpen(true)} className="w-screen lg:w-full  max-w-xxl mx-auto my-12 bg-[#faf6ff] rounded-3xl shadow-lg flex flex-col items-center px-6 py-10 hover:cursor-pointer">
  ...
  <DialogContent className="sm:max-w-[425px] bg-white rounded-md shadow-lg border border-purple-300">
    <DialogHeader>
      <DialogTitle className="text-purple-700 font-semibold">Create New Invoice</DialogTitle>
      <DialogDescription >
    ...
    <form onSubmit={handleSubmit}>
      <div className="grid gap-4 py-4">
        ...
        <div className="grid grid-cols-4 items-center gap-4">
          ...
          >
            <SelectTrigger className="col-span-3 border border-purple-400 focus:border-purple-600 focus:ring focus:ring-purple-300 rounded-md">
